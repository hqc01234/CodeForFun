...
namespace IdentityServer.Controllers.Account
{
    public class AccountController : Controller
    {
        ...
        /*****************************************/
        private async Task<LoginViewModel> BuildLoginViewModelAsync(string returnUrl, AuthorizationRequest rqContext = null)
        {
            var context = rqContext ?? await _interaction.GetAuthorizationContextAsync(returnUrl);
